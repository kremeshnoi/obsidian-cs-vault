...
[Listing 20-1](https://doc.rust-lang.org/book/#listing-20-1): Creating raw pointers with the raw borrow operators
...
[Listing 20-2](https://doc.rust-lang.org/book/#listing-20-2): Creating a raw pointer to an arbitrary memory address
...
[Listing 20-3](https://doc.rust-lang.org/book/#listing-20-3): Dereferencing raw pointers within an `unsafe` block
...
[Listing 20-4](https://doc.rust-lang.org/book/#listing-20-4): Using the safe `split_at_mut` function
...
[Listing 20-5](https://doc.rust-lang.org/book/#listing-20-5): An attempted implementation of `split_at_mut` using only safe Rust
...
[Listing 20-7](https://doc.rust-lang.org/book/#listing-20-7): Creating a slice from an arbitrary memory location
...
[Listing 20-8](https://doc.rust-lang.org/book/#listing-20-8): Declaring and calling an `extern` function defined in another language
...
[Listing 20-9](https://doc.rust-lang.org/book/#listing-20-9): Explicitly marking a function as `safe` within an `unsafe extern` block and calling it safely
...
[Listing 20-11](https://doc.rust-lang.org/book/#listing-20-11): Reading from or writing to a mutable static variable is unsafe.
...
For a much deeper exploration of how to work effectively with unsafe Rust, read Rust’s official guide for `unsafe`, [The Rustonomicon](https://doc.rust-lang.org/nomicon/).