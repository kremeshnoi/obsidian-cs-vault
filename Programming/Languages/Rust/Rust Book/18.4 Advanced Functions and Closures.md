...
source: "https://doc.rust-lang.org/book/ch20-04-advanced-functions-and-closures.html"
created: 2026-03-02
---
...
[Listing 20-28](https://doc.rust-lang.org/book/#listing-20-28): Using the `fn` type to accept a function pointer as an argument
...
[Listing 20-29](https://doc.rust-lang.org/book/#listing-20-29): Using a closure with the `map` method to convert numbers to strings
...
[Listing 20-30](https://doc.rust-lang.org/book/#listing-20-30): Using the `String::to_string` function with the `map` method to convert numbers to strings

Note that we must use the fully qualified syntax that we talked about in the [[18.2 Advanced Traits|“Advanced Traits”]] section because there are multiple functions available named `to_string`.
...
[Listing 20-31](https://doc.rust-lang.org/book/#listing-20-31): Using an enum initializer with the `map` method to create a `Status` instance from numbers
...
[Listing 20-33](https://doc.rust-lang.org/book/#listing-20-33): Creating a `Vec<T>` of closures defined by functions that return `impl Fn` types
...
[Listing 20-34](https://doc.rust-lang.org/book/#listing-20-34): Creating a `Vec<T>` of closures defined by functions that return `Box<dyn Fn>` so that they have the same type

This code will compile just fine. For more about trait objects, refer to the section [[16.2 Using Trait Objects to Abstract over Shared Behavior|“Using Trait Objects To Abstract over Shared Behavior”]] in Chapter 18.
