...
[Listing 17-14](https://doc.rust-lang.org/book/#listing-17-14): Using `thread::sleep` to simulate slow operations
...
[Listing 17-15](https://doc.rust-lang.org/book/#listing-17-15): Calling the `slow` function to simulate slow operations
...
[Listing 17-16](https://doc.rust-lang.org/book/#listing-17-16): Using `trpl::sleep` to let operations switch off making progress
...
[Listing 17-17](https://doc.rust-lang.org/book/#listing-17-17): Using `yield_now` to let operations switch off making progress
...
[Listing 17-18](https://doc.rust-lang.org/book/#listing-17-18): Using our imagined `timeout` to run a slow operation with a time limit
...
[Listing 17-19](https://doc.rust-lang.org/book/#listing-17-19): Defining the signature of `timeout`
...
[Listing 17-20](https://doc.rust-lang.org/book/#listing-17-20): Defining `timeout` with `select` and `sleep`
