...
at the tails of lists 'b' and 'c' are both list 'a'.](https://doc.rust-lang.org/book/img/trpl15-03.svg)
...
[Listing 15-17](https://doc.rust-lang.org/book/#listing-15-17): Demonstrating that we’re not allowed to have two lists using `Box<T>` that try to share ownership of a third list
...
[Listing 15-18](https://doc.rust-lang.org/book/#listing-15-18): A definition of `List` that uses `Rc<T>`
