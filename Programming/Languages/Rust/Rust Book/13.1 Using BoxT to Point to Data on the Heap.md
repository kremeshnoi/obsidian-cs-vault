...
[Listing 15-1](https://doc.rust-lang.org/book/#listing-15-1): Storing an `i32` value on the heap using a box
...
[Listing 15-2](https://doc.rust-lang.org/book/#listing-15-2): The first attempt at defining an enum to represent a cons list data structure of `i32` values
...
[Listing 15-3](https://doc.rust-lang.org/book/#listing-15-3): Using the `List` enum to store the list `1, 2, 3`
...
[Listing 15-4](https://doc.rust-lang.org/book/#listing-15-4): The error we get when attempting to define a recursive enum
...
[Listing 15-5](https://doc.rust-lang.org/book/#listing-15-5): The definition of `List` that uses `Box<T>` in order to have a known size
