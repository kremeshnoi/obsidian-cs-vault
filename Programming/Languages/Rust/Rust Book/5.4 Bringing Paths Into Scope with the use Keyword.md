...
[Listing 7-11](https://doc.rust-lang.org/book/#listing-7-11): Bringing a module into scope with `use`
...
[Listing 7-12](https://doc.rust-lang.org/book/#listing-7-12): A `use` statement only applies in the scope it’s in.
...
[Listing 7-13](https://doc.rust-lang.org/book/#listing-7-13): Bringing the `add_to_waitlist` function into scope with `use`, which is unidiomatic
...
[Listing 7-14](https://doc.rust-lang.org/book/#listing-7-14): Bringing `HashMap` into scope in an idiomatic way
...
[Listing 7-15](https://doc.rust-lang.org/book/#listing-7-15): Bringing two types with the same name into the same scope requires using their parent modules.
...
[Listing 7-16](https://doc.rust-lang.org/book/#listing-7-16): Renaming a type when it’s brought into scope with the `as` keyword
...
[Listing 7-17](https://doc.rust-lang.org/book/#listing-7-17): Making a name available for any code to use from a new scope with `pub use`
...
Re-exporting is useful when the internal structure of your code is different from how programmers calling your code would think about the domain. For example, in this restaurant metaphor, the people running the restaurant think about “front of house” and “back of house.” But customers visiting a restaurant probably won’t think about the parts of the restaurant in those terms. With `pub use`, we can write our code with one structure but expose a different structure. Doing so makes our library well organized for programmers working on the library and programmers calling the library. We’ll look at another example of `pub use` and how it affects your crate’s documentation in [[12.2 Publishing a Crate to Crates.io|“Exporting a Convenient Public API”]] in Chapter 14.
...
[Listing 7-18](https://doc.rust-lang.org/book/#listing-7-18): Specifying a nested path to bring multiple items with the same prefix into scope
...
[Listing 7-19](https://doc.rust-lang.org/book/#listing-7-19): Two `use` statements where one is a subpath of the other
...
[Listing 7-20](https://doc.rust-lang.org/book/#listing-7-20): Combining the paths in Listing 7-19 into one `use` statement
