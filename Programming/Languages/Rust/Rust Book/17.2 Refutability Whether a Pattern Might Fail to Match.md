---
title: "Refutability: Whether a Pattern Might Fail to Match - The Rust Programming Language"
...
[Listing 19-8](https://doc.rust-lang.org/book/#listing-19-8): Attempting to use a refutable pattern with `let`
...
[Listing 19-9](https://doc.rust-lang.org/book/#listing-19-9): Using `let...else` and a block with refutable patterns instead of `let`
...
[Listing 19-10](https://doc.rust-lang.org/book/#listing-19-10): Attempting to use an irrefutable pattern with `let...else`
