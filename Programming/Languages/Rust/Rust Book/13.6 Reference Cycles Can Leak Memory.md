...
[Listing 15-25](https://doc.rust-lang.org/book/#listing-15-25): A cons list definition that holds a `RefCell<T>` so that we can modify what a `Cons` variant is referring to
...
[Listing 15-26](https://doc.rust-lang.org/book/#listing-15-26): Creating a reference cycle of two `List` values pointing to each other
...
[Listing 15-27](https://doc.rust-lang.org/book/#listing-15-27): Creating a `leaf` node with no children and a `branch` node with `leaf` as one of its children
...
[Listing 15-28](https://doc.rust-lang.org/book/#listing-15-28): A `leaf` node with a weak reference to its parent node, `branch`
...
[Listing 15-29](https://doc.rust-lang.org/book/#listing-15-29): Creating `branch` in an inner scope and examining strong and weak reference counts
