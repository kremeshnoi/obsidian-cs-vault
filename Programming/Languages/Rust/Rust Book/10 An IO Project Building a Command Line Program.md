...
- Organizing code ([[5 Packages, Crates, and Modules|Chapter 7]])
- Using vectors and strings ([[6 Common Collections|Chapter 8]])
- Handling errors ([[7 Error Handling|Chapter 9]])
- Using traits and lifetimes where appropriate ([[8 Generic Types, Traits, and Lifetimes|Chapter 10]])
- Writing tests ([[9 Writing Automated Tests|Chapter 11]])

We’ll also briefly introduce closures, iterators, and trait objects, which [[11 Functional Language Features Iterators and Closures|Chapter 13]] and [[16 Object Oriented Programming Features|Chapter 18]] will cover in detail.