...
[Listing 3-2](https://doc.rust-lang.org/book/#listing-3-2): Assigning the result of an `if` expression to a variable
...
[Listing 3-3](https://doc.rust-lang.org/book/#listing-3-3): Using a `while` loop to run code while a condition evaluates to `true`
...
[Listing 3-4](https://doc.rust-lang.org/book/#listing-3-4): Looping through each element of a collection using a `while` loop
...
[Listing 3-5](https://doc.rust-lang.org/book/#listing-3-5): Looping through each element of a collection using a `for` loop
