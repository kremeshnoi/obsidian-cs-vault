...
source: "https://doc.rust-lang.org/book/ch20-03-advanced-types.html"
created: 2026-03-02
---
...
[Listing 20-25](https://doc.rust-lang.org/book/#listing-20-25): Using a long type in many places
...
[Listing 20-26](https://doc.rust-lang.org/book/#listing-20-26): Introducing a type alias, `Thunk`, to reduce repetition
...
[Listing 20-27](https://doc.rust-lang.org/book/#listing-20-27): A `match` with an arm that ends in `continue`

At the time, we skipped over some details in this code. In [[4.2 The match Control Flow Construct|“The `match` Control Flow Construct”]] section in Chapter 6, we discussed that `match` arms must all return the same type. So, for example, the following code doesn’t work:
