...
[Listing 17-23](https://doc.rust-lang.org/book/#listing-17-23): Awaiting futures in a collection
...
We’ll see more on this syntax in [[16 Object Oriented Programming Features|Chapter 18]]. For now, it’s enough to know that if we want to poll a future to check whether it is `Pending` or `Ready(Output)`, we need a `Pin` -wrapped mutable reference to the type.
...
[Listing 17-24](https://doc.rust-lang.org/book/#listing-17-24): Pinning the futures to enable moving them into the vector
...
If you want to understand how things work under the hood in even more detail, see Chapters [2](https://rust-lang.github.io/async-book/02_execution/01_chapter.html) and [4](https://rust-lang.github.io/async-book/04_pinning/01_chapter.html) of [*Asynchronous Programming in Rust*](https://rust-lang.github.io/async-book/).
