...
The book *Design Patterns: Elements of Reusable Object-Oriented Software* by Erich Gamma, Richard Helm, Ralph Johnson, and John Vlissides (Addison-Wesley, 1994), colloquially referred to as *The Gang of Four* book, is a catalog of object-oriented design [[Pattern|patterns]]. It defines OOP in this way:
...
[Listing 18-1](https://doc.rust-lang.org/book/#listing-18-1): An `AveragedCollection` struct that maintains a list of integers and the average of the items in the collection
...
[Listing 18-2](https://doc.rust-lang.org/book/#listing-18-2): Implementations of the public methods `add`, `remove`, and `average` on `AveragedCollection`
