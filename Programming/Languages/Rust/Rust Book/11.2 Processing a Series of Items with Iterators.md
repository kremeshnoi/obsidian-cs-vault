...
The iterator [[Pattern|pattern]] allows you to perform some task on a sequence of items in turn. An iterator is responsible for the logic of iterating over each item and determining when the sequence has finished. When you use iterators, you don’t have to reimplement that logic yourself.
...
[Listing 13-10](https://doc.rust-lang.org/book/#listing-13-10): Creating an iterator
...
[Listing 13-11](https://doc.rust-lang.org/book/#listing-13-11): Using an iterator in a `for` loop
...
[Listing 13-12](https://doc.rust-lang.org/book/#listing-13-12): Calling the `next` method on an iterator
...
[Listing 13-13](https://doc.rust-lang.org/book/#listing-13-13): Calling the `sum` method to get the total of all items in the iterator
...
[Listing 13-14](https://doc.rust-lang.org/book/#listing-13-14): Calling the iterator adapter `map` to create a new iterator
...
[Listing 13-15](https://doc.rust-lang.org/book/#listing-13-15): Calling the `map` method to create a new iterator, and then calling the `collect` method to consume the new iterator and create a vector
...
[Listing 13-16](https://doc.rust-lang.org/book/#listing-13-16): Using the `filter` method with a closure that captures `shoe_size`
